...
No active track: Water Vehicles shipped in full 2026-07-19 (3 waves, folded
into `ROADMAP.md`). The next 2026-H2 candidate is sea-industry
(`VISION_SEA_INDUSTRY.md`), which builds on the boat — it needs a spec
session before any wave codes.

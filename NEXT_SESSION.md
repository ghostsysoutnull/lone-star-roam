...
No active track — Railroads Realism (`RAILS_SPEC.md`, 3 waves) shipped
2026-07-19 and is folded into `ROADMAP.md`. Pull the next item from
`BACKLOG.md` to open a new track.

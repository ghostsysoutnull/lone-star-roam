...
See `ROADMAP.md` for planned work and known limitations before proposing features. Active track: **Energy** (`ENERGY_SPEC.md`, 6 waves, opened 2026-07-17 — briefing in `NEXT_SESSION.md`). Earlier tracks: aviation shipped 2026-07-12, Agriculture (`AGRICULTURE_SPEC.md`, all 5 waves + 4.5/5.5 follow-ons) shipped 2026-07-14, the Shoulder & the Shelf shipped 2026-07-15, Band Parity (`BAND_PARITY_SPEC.md`, 6 waves) shipped 2026-07-17, and New Player Experience (`NEWPLAYER_SPEC.md`, 4 waves) shipped 2026-07-17 — all folded into `ROADMAP.md`. Queued work lives in `BACKLOG.md`. **`GOTCHAS.md` is the law book** — standing rules that survived their tracks; grep it for the area you're changing before coding there. `LEDGER.md` is the per-wave scoreboard (one line per wave, appended at wave end).
